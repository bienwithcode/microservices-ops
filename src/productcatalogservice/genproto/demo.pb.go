...
const file_demo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"demo.proto\x12\vhipstershop\x1a\x1cgoogle/api/annotations.proto\"E\n" +
	"\bCartItem\x12\x1d\n" +
	"\n" +
	...
	"\x04text\x18\x02 \x01(\tR\x04text2\xa7\x02\n" +
	"\vCartService\x12c\n" +
	"\aAddItem\x12\x1b.hipstershop.AddItemRequest\x1a\x12.hipstershop.Empty\"'\x82\xd3\xe4\x93\x02!:\x04item\"\x19/api/cart/{user_id}/items\x12V\n" +
	"\aGetCart\x12\x1b.hipstershop.GetCartRequest\x1a\x11.hipstershop.Cart\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/api/cart/{user_id}\x12[\n" +
	"\tEmptyCart\x12\x1d.hipstershop.EmptyCartRequest\x1a\x12.hipstershop.Empty\"\x1b\x82\xd3\xe4\x93\x02\x15*\x13/api/cart/{user_id}2\xa0\x01\n" +
	"\x15RecommendationService\x12\x86\x01\n" +
	"\x13ListRecommendations\x12'.hipstershop.ListRecommendationsRequest\x1a(.hipstershop.ListRecommendationsResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/api/recommendations2\xce\x02\n" +
	"\x15ProductCatalogService\x12\\\n" +
	"\fListProducts\x12\x12.hipstershop.Empty\x1a!.hipstershop.ListProductsResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/api/products\x12^\n" +
	"\n" +
	"GetProduct\x12\x1e.hipstershop.GetProductRequest\x1a\x14.hipstershop.Product\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/api/products/{id}\x12w\n" +
	"\x0eSearchProducts\x12\".hipstershop.SearchProductsRequest\x1a#.hipstershop.SearchProductsResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/api/products/search2\xe5\x01\n" +
	"\x0fShippingService\x12g\n" +
	"\bGetQuote\x12\x1c.hipstershop.GetQuoteRequest\x1a\x1d.hipstershop.GetQuoteResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/api/shipping/quote\x12i\n" +
	"\tShipOrder\x12\x1d.hipstershop.ShipOrderRequest\x1a\x1e.hipstershop.ShipOrderResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/api/shipping/ship2\xf0\x01\n" +
	"\x0fCurrencyService\x12r\n" +
	"\x16GetSupportedCurrencies\x12\x12.hipstershop.Empty\x1a+.hipstershop.GetSupportedCurrenciesResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/api/currencies\x12i\n" +
	"\aConvert\x12&.hipstershop.CurrencyConversionRequest\x1a\x12.hipstershop.Money\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/api/currencies/convert2U\n" +
	"\x0ePaymentService\x12C\n" +
	"\x06Charge\x12\x1a.hipstershop.ChargeRequest\x1a\x1b.hipstershop.ChargeResponse\"\x002h\n" +
	"\fEmailService\x12X\n" +
	"\x15SendOrderConfirmation\x12).hipstershop.SendOrderConfirmationRequest\x1a\x12.hipstershop.Empty\"\x002z\n" +
	"\x0fCheckoutService\x12g\n" +
	"\n" +
	"PlaceOrder\x12\x1e.hipstershop.PlaceOrderRequest\x1a\x1f.hipstershop.PlaceOrderResponse\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\"\r/api/checkout2X\n" +
	"\tAdService\x12K\n" +
	"\x06GetAds\x12\x16.hipstershop.AdRequest\x1a\x17.hipstershop.AdResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/api/adsB?Z=github.com/GoogleCloudPlatform/microservices-demo/hipstershopb\x06proto3"
